...
addLine('> Initializing password analysis...', '', 200);
addLine('> Loading character set database...', '', 700);
...
addLine('> Calculating possible combinations...', '', 2400);

setTimeout(() => {
    const bar2 = document.createElement('div');
    bar2.className = 'progress-item';
    bar2.innerHTML = '<span class="progress-label">組み合わせ数の計算</span>'
        + '<div class="progress-bar-wrapper">'
...
addLine('> Simulating brute force attack...', '', 4000);
